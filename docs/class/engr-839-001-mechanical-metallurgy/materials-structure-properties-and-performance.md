...
|:--:|
| Microstructures in FeC #phase-diagram. #phase-diagram packs a lot of information for CPS of #CPSPP sequence. Lines denote what structure is found after some process with some chemical composition, which can be found by the [Lever Rule](lever-rule.md). |
...
[Burger's Vector](burgers-vector.md), $\vec{b}$
...
**Atomic Packing**
Dense #crystal-structure for metals.
...
4. #crystal-structure for metals simpler than structures for ceramics and polymers.
...
[Miller indices](miller-indices.md) give exact orientation or active atoms/planes to determine the associated properties.
