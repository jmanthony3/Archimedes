...
!!! example Use the *[Ludwik-Hollomann](ludwik-hollomann-hardening.md)* equation to determine work hardening exponent, $n$ in an alloy of true strain at 0.1 and true stress = 415 MPa. Assume $K = 1035 MPa$ and $\sigma_{0} = 0$.
    $$\begin{split}
