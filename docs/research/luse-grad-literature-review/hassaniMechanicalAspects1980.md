...
\\[
	\bar{P} = 3Y
	\tag{eq:avg_resisting_dynamic_pressure}
...
\\[
	...
	\tag{eq:plastic_zone_depth_expanded}
...
\\[
	...
	\tag{eq:final_indentation_modified}
...
\\[
	...
	\tag{eq:plastic_zone_depth_effective}
...
\\[
	...
	\tag{eq:meyer_indentation_law_modified}
...
\\[
	...
	\tag{eq:final_indentation_ultimate}
...
\\[
	...
	\end{cases}\bigg]
	\end{align*}
	\tag{eq:residual_stress_strain_at_depth_z}
...
\\[
	...
	\tag{eq:residual_stress_distribution}
...
\\[
	...
	\end{cases}
	\tag{eq:residual_stress_distribution_with_elasticity}
