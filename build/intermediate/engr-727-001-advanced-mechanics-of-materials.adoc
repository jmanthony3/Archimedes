...
++++
\begin{split}
\epsilon_{x} &= \frac{\partial u}{\partial x} = 2c = 2e-4 = 200u \\\epsilon_{y} &= \frac{\partial v}{\partial y} = -6cy = -(6e-4)(0.5) = -0.0003 \\\gamma_{xy} = \frac{\partial u}{\partial y} + \frac{\partial v}{\partial x} = 2cy + 2cx = (2e-4)(3 + 0.5) = 0.0007
\end{split}
++++
====
